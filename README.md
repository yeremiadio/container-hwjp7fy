...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hwjp7fy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hwjp7fy.containers.anotherwebservice.com/
...
```
git clone git@github.com:yeremiadio/container-hwjp7fy.git
cd container-hwjp7fy
```
...
```
docker attach container-hwjp7fy
```
